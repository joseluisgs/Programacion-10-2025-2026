...
**Hot Reload** permite ver cambios en XAML **sin reiniciar la aplicación**, acelerando enormemente el ciclo de diseño.
...
### 7.2 Configuración Detallada en Rider
...
### 7.3 Qué Funciona y Qué No — Tabla Comparativa
...
### 7.4 Mejores Prácticas con Hot Reload
...
### 8.1 El Problema: Rider No Tiene Diseñador Visual WPF
...
### 8.3 Flujo de Trabajo Completo: xaml.io + Rider
...
### 8.4 Ejemplos de XAML Generado por xaml.io

#### Fragmento 1 — Formulario de login básico
...
#### Fragmento 2 — Tarjeta de producto
...
#### Fragmento 3 — Barra de herramientas con botones de acción
...
#### Fragmento 4 — Dashboard con Grid de métricas
...
### 8.5 Integrar el XAML de xaml.io en un Proyecto Rider
...
| xaml.io | Herramienta online para prototipar XAML visualmente (suple la ausencia de diseñador en Rider) |
