...
- [5.1. Elementos de Navegación](#51-elementos-de-navegación)
  - [5.1.1. Window](#511-window-ventana)
  - [5.1.2. Frame](#512-frame-marco)
  - [5.1.3. Page](#513-page-página)
  - [5.1.4. Dialog](#514-dialog-diálogo)
  - [5.1.5. Resumen](#515-resumen)
- [5.2. Contenedores de Maquetación](#52-contenedores-de-maquetación)
- [5.3. Componentes de Entrada](#53-componentes-de-entrada)
- [5.4. Componentes de Acción](#54-componentes-de-acción)
- [5.5. Componentes de Selección](#55-componentes-de-selección)
- [5.6. Componentes de Visualización](#56-componentes-de-visualización)
- [5.7. Componentes de Datos Complejos](#57-componentes-de-datos-complejos)
- [5.8. Contenedores Especiales](#58-contenedores-especiales)
- [5.9. Propiedades Comunes](#59-propiedades-comunes)
- [5.10. Recursos Estáticos](#510-recursos-estáticos)

---

## 5.1. Elementos de Navegación: Window, Frame, Page, Dialog

Antes de los layouts, entender estos 4 elementos fundamentales:

### 5.1.1. Window (Ventana)
...
- **Raíz de toda aplicación** WPF
- Barra de título, bordes, botones min/max/close
- Se muestra con `Show()` o `ShowDialog()`
...
### 5.1.4. Dialog (Diálogo)

```xml
<Window x:Class="EditWindow" ShowInTaskbar="False" SizeToContent="WidthAndHeight">
    <!-- Diálogo modal -->
</Window>
```

- **Ventana secundaria** para edición/datos
- Typically modal (bloquea padre)
- Se muestra con `ShowDialog()`

### 5.1.5. Resumen

| Elemento | Tipo contenedor | Uso |
|----------|----------------|-----|
| Window | Raíz app | Ventana principal |
| Frame | Navegación | Contenedor de páginas |
| Page | Contenido | Vistas dentro de Frame |
| Dialog | Modal | Edición/confirmation |

---

## 5.2. Contenedores de Maquetación
...
### 5.2.7. Tabla Comparativa de Panels
...
## 5.6. Componentes de Visualización
...
## 5.7. Componentes de Datos Complejos
...
### 5.8.5. Separator y ScrollViewer
...
### 5.10.3. StaticResource vs DynamicResource
...
### 5.10.4. Jerarquía de búsqueda de recursos
