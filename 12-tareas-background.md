# 12. Tareas en Background: No Bloquear la Interfaz

- [12.1. El Problema: UI Bloqueada](#121-el-problema-ui-bloqueada)
  - [12.1.1. Ejemplo de problema](#1211-ejemplo-de-problema)
- [12.2. Soluciones: Thread, Task, async/await](#122-soluciones-thread-task-asyncawait)
  - [12.2.1. Thread (enfoque clásico)](#1221-thread-enfoque-clásico)
  - [12.2.2. Task.Run (enfoque moderno)](#1222-taskrun-enfoque-moderno)
  - [12.2.3. async/await (enfoque recomendado)](#1223-asyncawait-enfoque-recomendado)
- [12.3. Dispatcher: El Puente al Hilo UI](#123-dispatcher-el-puente-al-hilo-ui)
...
## 12.2. Soluciones: Thread, Task, async/await
...
## 12.3. Dispatcher: El Puente al Hilo UI
...
## 12.4. IProgress\<T\>: Reportar Progreso
...
## 12.5. CancellationToken: Cancelar Operaciones
...
## 12.6. HttpClient y operaciones I/O
...
## 12.7. Comandos Asíncronos en MVVM
...
> 💡 **Tip del Examinador**: Pregunta frecuente: "¿Qué ocurre si haces Thread.Sleep(5000) en un botón?" - Respuesta: La UI se congela durante 5 segundos porque bloqueas el UI Thread. La respuesta correcta es usar async/await con Task.Delay(5000). Otra pregunta común: "¿Para qué sirve Dispatcher?" → Para actualizar la UI desde un hilo secundario. Sin embargo, con async/await NO necesitas Dispatcher porque ya se encarga automáticamente.
