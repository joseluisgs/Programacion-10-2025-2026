...
**Contras:**
- ❌ Requiere ObservableCollection para notificaciones
...
|-----------|-------------|
| **ValidationRules** | Validación en el binding |
| **IDataErrorInfo** | Validación en el ViewModel |
| **OneWay + Eventos** | Validación manual con lógica extra |
