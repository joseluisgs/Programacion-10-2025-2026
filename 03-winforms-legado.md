...
> 💡 **Tip del Examinador**: Pregunta clásica de examen: "¿Por qué usar WinForms o WPF?" - Respuesta: WinForms para apps simples/rápidas o legacy. WPF para apps empresariales con requisitos visuales/complejos.
...
> 📝 **Nota del Profesor**: WinForms es ideal para entender los fundamentos de la programación orientada a eventos. Aunque no lo usarás en proyectos profesionales nuevos, los conceptos (eventos, controladores, layout) se aplican directamente a WPF. Si dominas WinForms, entenderás mejor por qué WPF mejora con XAML y data binding.
