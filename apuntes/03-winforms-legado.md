# 03 - Windows Forms: La Primera GUI de .NET
...
Windows Forms surgió como la respuesta de Microsoft a **Java Swing** y **Java AWT**. Microsoft necesitaba una forma de crear aplicaciones de escritorio nativas para Windows usando el nuevo framework .NET, y WinForms fue su solución inicial.
...
## 2. Arquitectura de Windows Forms
...
### 3.1 Mediante Código (Forma Moderna - C# 14)
...
### 3.2 Mediante Diseñador Visual (Rider/Visual Studio)
...
## 4. Controles Fundamentales de WinForms

### 4.1 Catálogo de Controles Básicos
...
### 4.2 Ejemplo: Formulario de Registro
...
## 5. Manejo de Eventos en WinForms
...
### 5.3 Timer y Eventos Periódicos
...
### 6.1 Posicionamiento Absoluto vs. Anclado
...
### 6.2 TableLayoutPanel y FlowLayoutPanel
...
### 8.2 OpenFileDialog y SaveFileDialog
...
## 9. Limitaciones de Windows Forms

### 9.1 Comparación con WPF
...
## 10. Ejemplo Integrador: Calculadora
...
|----------|-------------|
| WinForms | Primera tecnología GUI de .NET (2002) |
| Form | Clase que representa una ventana |
| Control | Clase base para elementos visuales |
| Event-driven | Arquitectura basada en eventos |
| GDI+ | Motor de renderizado gráfico |
| Designer | Herramienta visual para diseñar formularios |
| Legacy | Tecnología antigua pero estable |

---

## 12. Ejercicios Propuestos

1. **Lista de Tareas**: Crea una aplicación para gestionar una lista de tareas con botones para añadir, eliminar y marcar como completadas.

2. **Conversor de Unidades**: Implementa un conversor de unidades (metros/pies, kg/libras, etc.) con ComboBox y TextBox.

3. **Bloc de Notas**: Crea un editor de texto simple con menú (Abrir, Guardar, Salir) y barra de herramientas.

4. **Cronómetro**: Implementa un cronómetro con botones de Start, Stop y Reset usando Timer.
...
Ver ejemplos completos en `/soluciones/03-winforms/`
