...
public class ReportService : IReportService
{
    ...
    public Result<string, DomainError> GenerarInformeEstudiantesHtml(IEnumerable<Estudiante> estudiantes, bool mostrarEliminado = false)
    {
...
<body>
    ...
    public Result<string, DomainError> GenerarListadoPersonasHtml(IEnumerable<Persona> personas, bool mostrarEliminado = false)
    {
