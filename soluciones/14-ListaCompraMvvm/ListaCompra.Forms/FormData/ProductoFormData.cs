...
/// </summary>
public partial class ProductoFormData : ObservableObject, IDataErrorInfo
{
    [ObservableProperty]
    ...
    /// </summary>
    public static ProductoFormData FromModel(Producto producto)
    {
        return new ProductoFormData
        {
            Nombre = producto.Nombre,
            Cantidad = producto.Cantidad.ToString(),
            Precio = producto.Precio.ToString(CultureInfo.InvariantCulture)
        };
    }
}