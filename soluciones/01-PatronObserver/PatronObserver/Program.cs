...
using PatronObserver.Ejercicio6;
...
// ============================================================
// Demuestra por qué ObservableCollection es fundamental en WPF:
// - DataGrid, ComboBox, ListBox se suscriben a CollectionChanged
// - Sin ella, la UI no se entera de los cambios
// - Diferencia entre flujos fríos (IEnumerable) y calientes (ObservableCollection)
Console.WriteLine("\n" + "=".PadRight(50, '='));
Console.WriteLine("EJERCICIO 6: ObservableCollection<T> y Flujos");
Console.WriteLine("=".PadRight(50, '='));

DemoObservableCollection.Ejecutar();
DemoListVsObservable.Ejecutar();
DemoFlujos.Ejecutar();
