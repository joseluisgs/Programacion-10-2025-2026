...
public partial class SelectionWindow : Window
{
    ...
    {
        // Verificar que los controles están inicializados
        if (txtResumen == null) return;
    ...
    {
        // Verificar que los controles están inicializados
        if (chkOpcion1 == null || txtResumen == null) return;
    ...
    {
        // Verificar que los controles están inicializados (el evento se dispara durante carga)
        if (lblPais == null) return;
    ...
    {
        // Verificar que los controles están inicializados
        if (txtResumen == null || chkAcepto == null || cmbPais == null) return;
