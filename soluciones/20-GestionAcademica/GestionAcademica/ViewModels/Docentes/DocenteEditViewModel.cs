...
public partial class DocenteEditViewModel(
    ...
    [ObservableProperty] private DocenteFormData _formData = docente.ToFormData();

    /// <summary>
    ///     Título de la ventana según el modo de operación (nuevo o edición).
    /// </summary>
    [ObservableProperty] private string _windowTitle = isNew ? "Nuevo Docente" : "Editar Docente";
