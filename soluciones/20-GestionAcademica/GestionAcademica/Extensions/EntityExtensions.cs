...
{
    /// <summary>Crea una copia independiente del estudiante preservando todos sus valores.</summary>
    ...
    /// <summary>Crea una copia independiente del docente preservando todos sus valores.</summary>
