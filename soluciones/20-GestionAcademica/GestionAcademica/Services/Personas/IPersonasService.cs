...
public interface IPersonasService {
    ...
    /// <returns>
    ///     Result con la persona encontrada o error <see cref="Errors.Personas.PersonaErrors.NotFound(string)" /> si no
    ///     existe.
    /// </returns>
    ...
    /// <returns>
    ///     Result con la persona restaurada o error <see cref="Errors.Personas.PersonaErrors.NotFound(string)" /> si no existe
    ///     o no está eliminada.
    /// </returns>
