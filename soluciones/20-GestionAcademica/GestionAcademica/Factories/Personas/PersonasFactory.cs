...
public static class PersonasFactory {
    ...
    public static IEnumerable<Persona> Seed() {
        ...
        lista.Add(new Estudiante {
            Dni = "22222222J", Nombre = "Pedro", Apellidos = "Ruiz", 
        ...
        lista.Add(new Estudiante {
            Dni = "88888888Y", Nombre = "Jorge", Apellidos = "Sánchez", 
        ...
        lista.Add(new Estudiante {
            Dni = "99999999R", Nombre = "Laura", Apellidos = "Fernández", 
        ...
        lista.Add(new Docente {
            Dni = "12345678Z", Nombre = "Jose Luis", Apellidos = "González", 
        ...
        lista.Add(new Docente {
            Dni = "45678901G", Nombre = "Marta", Apellidos = "García", 
        ...
        lista.Add(new Docente {
            Dni = "56789012B", Nombre = "Raúl", Apellidos = "Martínez", 
