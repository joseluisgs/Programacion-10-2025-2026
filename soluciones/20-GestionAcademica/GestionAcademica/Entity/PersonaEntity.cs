...
public class PersonaEntity {
    ...
    [MaxLength(500)] public string? Imagen { get; set; }

    [Required] [MaxLength(20)] public string Tipo { get; set; } = "Persona";
    ...
    [Column(TypeName = "decimal(5,2)")] public double? Calificacion { get; set; }
