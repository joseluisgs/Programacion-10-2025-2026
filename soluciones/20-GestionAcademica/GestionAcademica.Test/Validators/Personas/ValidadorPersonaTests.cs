...
public class ValidadorPersonaTests
{
    ...
    public class CasosNegativos
    {
        ...
        public void Validar_NombreVacio_DeberiaRetornarFailure()
        {
            ...
            (resultado.Error as PersonaError.Validation)?.Errors.Should().Contain("El nombre es obligatorio (2-30 car.).");
        ...
        public void Validar_ApellidosVacios_DeberiaRetornarFailure()
        {
            ...
            resultado.IsFailure.Should().BeTrue();
            resultado.Error.Should().BeOfType<PersonaError.Validation>();
            (resultado.Error as PersonaError.Validation)?.Errors.Should().Contain("Los apellidos son obligatorios (2-50 car.).");
            resultado.Error.Message.Should().Contain("Se han detectado errores de validación en la entidad:");
        }
        ...
        public void Validar_FechaFutura_DeberiaRetornarFailure()
        {
            ...
            resultado.IsFailure.Should().BeTrue();
            resultado.Error.Should().BeOfType<PersonaError.Validation>();
            (resultado.Error as PersonaError.Validation)?.Errors.Should().Contain("La fecha de nacimiento debe ser entre 1900 y hoy.");
            resultado.Error.Message.Should().Contain("Se han detectado errores de validación en la entidad:");
        }
        ...
        public void Validar_EmailInvalido_DeberiaRetornarFailure()
        {
            ...
            resultado.IsFailure.Should().BeTrue();
            resultado.Error.Should().BeOfType<PersonaError.Validation>();
            (resultado.Error as PersonaError.Validation)?.Errors.Should().Contain("El email no tiene un formato válido.");
            resultado.Error.Message.Should().Contain("Se han detectado errores de validación en la entidad:");
        }
