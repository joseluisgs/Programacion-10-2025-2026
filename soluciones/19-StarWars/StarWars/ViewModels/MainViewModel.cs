...
public partial class MainViewModel(DroideGenerator droideGenerator) : ObservableObject
{
    ...
    private async Task IniciarAsync()
    {
        ...
        // Calcular el rendimiento (porcentaje de aciertos)
