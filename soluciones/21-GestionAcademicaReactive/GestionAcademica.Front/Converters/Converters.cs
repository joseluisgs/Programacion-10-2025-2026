...
/// <summary>
///     Convertidores de valores para binding en WPF.
///     Proporciona conversiones comunes como BoolToVisibility, ImagePath, etc.
/// </summary>
...
public class ImagePathConverter : IValueConverter {
    public object? Convert(object value, Type targetType, object parameter, CultureInfo culture) {
        if (value == null || string.IsNullOrWhiteSpace(value.ToString())) return GetDefaultImage();
    ...
    private static BitmapImage? GetDefaultImage() {
        try {
            var defaultPath = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "Resources", "images",
                "sin-imagen.png");
