...
/// <summary>
///     FormData para la validación de Docente en la capa de presentación.
///     Separa la lógica de validación UI del modelo de dominio puro.
///     IMPORTANTE: Este es el único lugar donde se implementa IDataErrorInfo para Docente.
/// </summary>
public partial class DocenteFormData : ObservableObject, IDataErrorInfo {
    ...
    [ObservableProperty] private DateTime _fechaNacimiento = DateTime.Today.AddYears(-30);
    ...
    public bool IsValid() {
        return string.IsNullOrEmpty(this[nameof(Nombre)]) &&
               ...
               string.IsNullOrEmpty(this[nameof(Experiencia)]) &&
               string.IsNullOrEmpty(this[nameof(Especialidad)]);
    }
    ...
    public string GetValidationErrors() {
        var campos = new[] {
            ...
            (nameof(Experiencia), "Experiencia"),
            (nameof(Especialidad), "Especialidad")
        };
