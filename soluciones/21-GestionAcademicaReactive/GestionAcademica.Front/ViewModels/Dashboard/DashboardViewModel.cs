...
public partial class DashboardViewModel : ObservableObject {
    ...
    private void LoadStatistics() {
        try {
            ...
            TotalEstudiantes = _personasService.CountEstudiantes();
            TotalDocentes = _personasService.CountDocentes();

            _logger.Information($"Total estudiantes: {TotalEstudiantes}, Total docentes: {TotalDocentes}");

            var notaCorte = AppConfig.NotaAprobado;
            var aprobados = _personasService.CountAprobados(notaCorte);
            var suspensos = _personasService.CountSuspensos(notaCorte);
            ...
            var estudiantesPorCiclo = _personasService.GetEstudiantesPorCiclo();
            var docentesPorCiclo = _personasService.GetDocentesPorCiclo();
