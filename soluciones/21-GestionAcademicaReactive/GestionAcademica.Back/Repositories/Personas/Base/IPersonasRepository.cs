...
public interface IPersonasRepository {
    ...
    /// <summary>
    ///     Obtiene estudiantes ordenados y paginados (paginación real en BD).
    /// </summary>
    ...
    IEnumerable<Estudiante> GetEstudiantesOrderBy(string orden, int page = 1, int pageSize = 10, bool includeDeleted = true);

    /// <summary>
    ///     Obtiene docentes ordenados y paginados (paginación real en BD).
    /// </summary>
    /// <param name="orden">Criterio de ordenación.</param>
    /// <param name="page">Número de página.</param>
    /// <param name="pageSize">Tamaño de página.</param>
    ...
    IEnumerable<Docente> GetDocentesOrderBy(string orden, int page = 1, int pageSize = 10, bool includeDeleted = true);
