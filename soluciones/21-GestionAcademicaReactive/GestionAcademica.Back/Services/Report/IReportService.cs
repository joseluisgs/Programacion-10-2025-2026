...
public interface IReportService {
    ...
    InformeEstudiante GenerarInformeEstudiante(IEnumerable<Estudiante> estudiantes, double notaAprobado,
    ...
    ///     <see cref="Errors.Report.ReportErrors.GenerationError(string)" /> o
    ///     <see cref="Errors.Report.ReportErrors.StorageError(string)" />.
    /// </returns>
