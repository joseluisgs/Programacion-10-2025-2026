...
public interface IImageService {
    ...
    /// <returns>
    ///     Success si el archivo existe y su tamaño es menor o igual al máximo permitido; Failure con el error
    ...
    /// <returns>
    ///     Success si las dimensiones son válidas o no se pueden determinar; Failure con el error correspondiente si
    ///     superan los límites.
    /// </returns>
    ...
    /// <returns>
    ///     Success con el BitmapImage si la imagen se puede cargar; Failure con el error correspondiente en caso
    ///     contrario.
    /// </returns>
