    ...
    public class CasosNegativos {
        ...
        public void Validar_CalificacionNegativa_DeberiaRetornarFailure() {
            ...
            (resultado.Error as PersonaError.Validation)?.Errors.Should()
                .Contain("La calificación debe estar entre 0.0 y 10.0.");
        ...
        public void Validar_CursoInvalido_DeberiaRetornarFailure() {
            ...
            resultado.Error.Should().BeOfType<PersonaError.Validation>();
            (resultado.Error as PersonaError.Validation)?.Errors.Should()
                .Contain("El curso académico no es válido (Primero o Segundo).");
            resultado.Error.Message.Should().Contain("Se han detectado errores de validación en la entidad:");
        }

        [Test]
        public void Validar_EstudianteInvalido_DeberiaRetornarFailure() {
            // Arrange
            var estudiante = new Estudiante {
                Id = 1,
                Dni = "12345678H",
