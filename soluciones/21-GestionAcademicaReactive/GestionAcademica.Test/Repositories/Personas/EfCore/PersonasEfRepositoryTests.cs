...
public class PersonasEfRepositoryTests {
    ...
    public class CasosPositivos {
        ...
        public void SetUp() {
            ...
            _repository = new PersonasEfRepository(_context, dropData: true, seedData: false);
        }
        ...
        public void Update_ConDatosValidos_DeberiaActualizar() {
            ...
            var created = _repository.Create(estudiante);
    ...
    public class CasosMixtos {
        ...
        [Test]
        public void GetEstudiantesOrderBy_Paginacion_DeberiaOrdenarPorDni() {
            // Arrange
        ...
        [Test]
        public void GetDocentesOrderBy_Paginacion_DeberiaOrdenarPorExperiencia() {
            // Arrange
