    ...
    public class CasosPositivos {
        ...
        public void Constructor_ConDocentes_DeberiaCargarLista() {
            ...
            _personasServiceMock.Setup(s =>
                    s.GetDocentesOrderBy(It.IsAny<TipoOrdenamiento>(), It.IsAny<int>(), It.IsAny<int>(),
                        It.IsAny<bool>()))
                .Returns(docentes);
...
viewModel.EditCommand.CanExecute(null).Should().BeFalse();
        ...
        public void SearchText_Cambio_DeberiaFiltrarEnMemoria() {
            ...
            _personasServiceMock.Setup(s =>
                    s.GetDocentesOrderBy(It.IsAny<TipoOrdenamiento>(), It.IsAny<int>(), It.IsAny<int>(), It.IsAny<bool>()))
                .Returns(docentes);
        ...
        public void MostrarEliminados_Cambio_DeberiaRecargar() {
            ...
            _personasServiceMock.Setup(s =>
                    s.GetDocentesOrderBy(It.IsAny<TipoOrdenamiento>(), 1, int.MaxValue, false))
                .Returns(docentesEliminados);
            ...
            _personasServiceMock.Verify(s =>
                s.GetDocentesOrderBy(It.IsAny<TipoOrdenamiento>(), 1, int.MaxValue, false), Times.Once);
        }
