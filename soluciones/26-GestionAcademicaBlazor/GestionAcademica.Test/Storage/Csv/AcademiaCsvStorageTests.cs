...
public class AcademiaCsvStorageTests {
    ...
    public class CasosNegativos {
        ...
        public async Task Cargar_CuandoArchivoNoExiste_DeberiaRetornarError() {
            // Arrange & Act
            var resultado = await _storage.CargarAsync("ruta/inexistente.csv");
        ...
        [Test]
        public async Task Cargar_CuandoArchivoTieneFormatoInvalido_DeberiaRetornarError() {
        ...
        public async Task Salvar_EnRutaInvalida_DeberiaRetornarError() {
            ...
            // Act
            var resultado = await _storage.SalvarAsync(personas, "/ruta/invalida/archivo.csv");
