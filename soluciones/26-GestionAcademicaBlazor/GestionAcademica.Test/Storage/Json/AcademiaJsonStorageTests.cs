...
public class AcademiaJsonStorageTests {
    ...
    public class CasosNegativos {
        ...
        public async Task Cargar_CuandoArchivoNoExiste_DeberiaRetornarError() {
            // Arrange & Act
            var resultado = await _storage.CargarAsync("ruta/inexistente.json");
        ...
        public async Task Salvar_EnRutaInvalida_DeberiaRetornarError() {
            ...
            // Act
            var resultado = await _storage.SalvarAsync(personas, "/ruta/invalida/archivo.json");
    ...
    public class CasosMixtos {
        ...
        public async Task SalvarYLeer_RoundTrip_DeberiaMantenerDatos() {
            ...
            // Act
            var saveResult = await _storage.SalvarAsync(original, _tempPath);
            var loadResult = await _storage.CargarAsync(_tempPath);
        ...
        [Test]
        public async Task Salvar_ConEstudianteEliminado_DeberiaMantenerEstadoEliminado() {
            // Arrange
            var personas = new List<Persona> {
                new Estudiante {
