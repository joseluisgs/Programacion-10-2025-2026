...
public class BackupViewModelTests {
    ...
    public class CasosPositivos {
        ...
        [Test]
        public async Task Constructor_ConBackupsDisponibles_DeberiaCargarLista() {
            // Arrange
            _backupServiceMock.Setup(b => b.ListarBackupsAsync(It.IsAny<string?>()))
                .ReturnsAsync(new List<string> { "backup1.zip", "backup2.zip", "backup3.zip" });
        ...
        [Test]
        public async Task Constructor_SinBackups_DeberiaRetornarListaVacia() {
            // Arrange
            _backupServiceMock.Setup(b => b.ListarBackupsAsync(It.IsAny<string?>()))
        ...
        [Test]
        public async Task PropiedadesPorDefecto_DeberianTenerValoresIniciales() {
            // Arrange
            _backupServiceMock.Setup(b => b.ListarBackupsAsync(It.IsAny<string?>()))
                .ReturnsAsync(new List<string>());
        ...
        [Test]
        public async Task SelectedBackup_SePuedeAsignar() {
            // Arrange
            _backupServiceMock.Setup(b => b.ListarBackupsAsync(It.IsAny<string?>()))
                .ReturnsAsync(new List<string>());
            var viewModel = new BackupViewModel(
        ...
        [Test]
        public async Task SelectedBackup_SePuedeCambiar() {
            // Arrange
            _backupServiceMock.Setup(b => b.ListarBackupsAsync(It.IsAny<string?>()))
                .ReturnsAsync(new List<string>());
            var viewModel = new BackupViewModel(
        ...
        [Test]
        public async Task StatusMessage_SePuedeAsignar() {
            // Arrange
            _backupServiceMock.Setup(b => b.ListarBackupsAsync(It.IsAny<string?>()))
                .ReturnsAsync(new List<string>());
            var viewModel = new BackupViewModel(
        ...
        [Test]
        public async Task IsLoading_SePuedeCambiarAVerdadero() {
            // Arrange
            _backupServiceMock.Setup(b => b.ListarBackupsAsync(It.IsAny<string?>()))
                .ReturnsAsync(new List<string>());
            var viewModel = new BackupViewModel(
        ...
        [Test]
        public async Task IsLoading_SePuedeCambiarAFalso() {
            // Arrange
            _backupServiceMock.Setup(b => b.ListarBackupsAsync(It.IsAny<string?>()))
                .ReturnsAsync(new List<string>());
            var viewModel = new BackupViewModel(
    ...
    public class CasosNegativos {
        [Test]
        public async Task Constructor_CuandoListarBackupsFalla_DeberiaMostrarError() {
            // Arrange
            var backupServiceMock = new Mock<IBackupService>();
            backupServiceMock.Setup(b => b.ListarBackupsAsync(It.IsAny<string?>()))
                .ThrowsAsync(new Exception("Error de disco"));
        ...
        [Test]
        public async Task Constructor_CuandoServicioEsNulo_NoDeberiaFallar() {
            // Arrange & Act
            var viewModel = new BackupViewModel(
                new Mock<IPersonasService>().Object,
