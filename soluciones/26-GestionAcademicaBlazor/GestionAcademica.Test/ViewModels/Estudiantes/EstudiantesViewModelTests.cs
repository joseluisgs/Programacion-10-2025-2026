...
public class EstudiantesViewModelTests {
    ...
    public class CasosPositivos {
        ...
        [Test]
        public async Task Constructor_ConEstudiantes_DeberiaCargarLista() {
            // Arrange
            ...
            _personasServiceMock.Setup(s =>
                    s.GetEstudiantesOrderByAsync(It.IsAny<TipoOrdenamiento>(), It.IsAny<int>(), It.IsAny<int>(),
                        It.IsAny<bool>()))
        ...
        [Test]
        public async Task Constructor_SinEstudiantes_DeberiaRetornarListaVacia() {
            // Arrange
            _personasServiceMock.Setup(s =>
                    s.GetEstudiantesOrderByAsync(It.IsAny<TipoOrdenamiento>(), It.IsAny<int>(), It.IsAny<int>(),
                        It.IsAny<bool>()))
        ...
        [Test]
        public async Task PaginaAnteriorCommand_CuandoPaginaEsMayorQue1_DeberiaEjecutarse() {
            // Arrange
        ...
        [Test]
        public async Task PaginaSiguienteCommand_CuandoHayMasPaginas_DeberiaEjecutarse() {
            // Arrange
            var estudiantes = GenerarEstudiantes(25);
            _personasServiceMock.Setup(s =>
                    s.GetEstudiantesOrderByAsync(It.IsAny<TipoOrdenamiento>(), It.IsAny<int>(), It.IsAny<int>(),
        ...
        [Test]
        public async Task SearchText_CuandoCambia_DeberiaFiltrarEstudiantes() {
            // Arrange
            var estudiantes = new List<Estudiante> {
        ...
        [Test]
        public async Task SelectedEstudiante_SePuedeAsignar() {
            // Arrange
            var estudiantes = new List<Estudiante> {
    ...
    public class CasosNegativos {
        ...
        [Test]
        public async Task Constructor_CuandoGetEstudiantesFalla_DeberiaManejarError() {
            // Arrange
            _personasServiceMock.Setup(s =>
                    s.GetEstudiantesOrderByAsync(It.IsAny<TipoOrdenamiento>(), It.IsAny<int>(), It.IsAny<int>(),
                        It.IsAny<bool>()))
        ...
        public async Task SearchText_Cambio_DeberiaFiltrarEnMemoria() {
            ...
            _personasServiceMock.Setup(s =>
                    s.GetEstudiantesOrderByAsync(It.IsAny<TipoOrdenamiento>(), It.IsAny<int>(), It.IsAny<int>(), It.IsAny<bool>()))
                .ReturnsAsync(estudiantes);
        ...
        public async Task MostrarEliminados_Cambio_DeberiaRecargar() {
            ...
            _personasServiceMock.Setup(s =>
                    s.GetEstudiantesOrderByAsync(It.IsAny<TipoOrdenamiento>(), 1, int.MaxValue, false))
                .ReturnsAsync(estudiantesEliminados);
            ...
            _personasServiceMock.Verify(s =>
                s.GetEstudiantesOrderByAsync(It.IsAny<TipoOrdenamiento>(), 1, int.MaxValue, false), Times.Once);
        }
