...
public class ReportService : IReportService {
    ...
    public async Task<InformeEstudiante> GenerarInformeEstudianteAsync(IEnumerable<Estudiante> estudiantes, double notaAprobado,
    ...
    public async Task<InformeDocente> GenerarInformeDocenteAsync(IEnumerable<Docente> docentes, Ciclo? ciclo = null) {
        await Task.CompletedTask;
    ...
    public async Task<Result<string, DomainError>> GenerarInformeEstudiantesHtmlAsync(IEnumerable<Estudiante> estudiantes,
        bool mostrarEliminado = false, bool mostrarMenoresEdad = false) {
        await Task.CompletedTask;
        ...
        try {
            ...
            var headers =
                @"<th>DNI</th><th>Nombre</th><th>Apellidos</th><th>Fecha Nacimiento</th><th>Email</th><th>Mayor de edad</th><th>Ciclo</th><th>Curso</th><th class=""nota"">Nota</th><th class=""nota"">Estado</th>";
...
<body>
    ...
    public async Task<Result<string, DomainError>> GenerarInformeDocentesHtmlAsync(IEnumerable<Docente> docentes,
        ...
        try {
            ...
            var headers =
                @"<th>DNI</th><th>Nombre</th><th>Apellidos</th><th>Fecha Nacimiento</th><th>Email</th><th>Especialidad</th><th>Ciclo</th><th class=""experiencia"">Experiencia</th>";
            if (mostrarEliminado) headers += "<th>Eliminado</th>";
...
<body>
    ...
    public async Task<Result<string, DomainError>> GenerarListadoPersonasHtmlAsync(IEnumerable<Persona> personas,
        bool mostrarEliminado = false, bool mostrarMenoresEdad = false) {
        await Task.CompletedTask;
        ...
        try {
            ...
            var headers =
                @"<th>ID</th><th>DNI</th><th>Nombre</th><th>Apellidos</th><th>Fecha Nacimiento</th><th>Email</th><th class=""tipo"">Tipo</th>";
...
<body>
    ...
    public async Task<Result<bool, DomainError>> GuardarInformeAsync(string html, string fileName) {
    ...
    public async Task<Result<bool, DomainError>> GuardarInformePdfAsync(string html, string fileName) {
        var directory = _reportDirectory;
