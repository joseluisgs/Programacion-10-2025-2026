...
public interface IBackupService {
    ...
    /// </returns>
    Task<Result<string, DomainError>> RealizarBackupAsync(
    ...
    /// </returns>
    Task<Result<IEnumerable<Persona>, DomainError>> RestaurarBackupAsync(
    ...
    Task<IEnumerable<string>> ListarBackupsAsync(string? customBackupDirectory = null);
    ...
    ///     <see cref="BackupErrors.InvalidBackupFile(string)" />.
    /// </returns>
    Task<Result<string, DomainError>> RealizarBackupSistemaAsync(IEnumerable<Persona> personas);
    ...
    ///     <see cref="BackupErrors.RestorationError(string)" />.
    /// </returns>
    Task<Result<int, DomainError>> RestaurarBackupSistemaAsync(
        string archivoBackup,
