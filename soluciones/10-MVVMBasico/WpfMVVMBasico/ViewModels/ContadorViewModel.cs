    ...
    public int Contador
    {
        ...
        set
        {
            ...
            if (_contador != value)
            {
                ...
                // [CallerMemberName] obtiene automaticamente el nombre de la propiedad
                OnPropertyChanged();
                
                // Tambien notificamos a CanExecute de los comandos
                // Esto actualizara el estado de los botones
