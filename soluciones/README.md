...
| 20 | [GestionAcademica](./20-GestionAcademica/) | MVVM profesional | **Proyecto final**: CRUD, imágenes, ScottPlot, NUnit |
| 21 | [ListaTareasBlazor](./21-ListaTareasBlazor/) | Blazor Server | Introducción a Blazor |
| 22 | [ListaTareasMAUI](./22-ListaTareasMAUI/) | .NET MAUI | Introducción a MAUI |
| 23 | [ListaTareasAvalonia](./23-ListaTareasAvalonia/) | Avalonia UI | Framework multiplataforma |
| 24 | [ListaTareasOpenSilver](./24-ListaTareasOpenSilver/) | OpenSilver | WPF en navegador (WebAssembly) |
...
17 → 18        Repositorios y Background Tasks
  ↓
19              Proyecto integrador
  ↓
20              Estilos y Temas
  ↓
21              Proyecto final profesional
  
========================================
       PROYECTOS OPCIONALES
   ↓
22 → 24         Blazor + MAUI + Avalonia + OpenSilver
```
