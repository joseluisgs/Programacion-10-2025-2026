...
> 💡 **Tip del Examinador**: Pregunta frecuente de examen: "¿Cuál es la diferencia entre un delegado y un evento?" - Respuesta: Un delegado es un tipo que referencia métodos; un evento es un delegado con protección (solo se puede invocar desde la clase que lo declara).
...
> 💡 **Tip del Examinador**: Los memory leaks por eventos no desuscritos son un problema clásico. En el examen pueden preguntarte cómo evitarlos. - Respuesta: Siempre desuscribirse en el evento Closing/Disposed, o usar WeakEventManager.
